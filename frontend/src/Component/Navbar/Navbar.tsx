      ...
      <nav className="navbar navbar-expand-lg bg-slate-900 h-20 flex  items-center justify-between  ">
        <div className="flex ">
          ...
          <div className="ml-20  bg-slate-900 flex items-center justify-center md:pr-3 md:mr-2">
            <input
              className=" lg:hidden shadow appearance-none border  w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="username"
              type="text"
              placeholder="Search..."
            />
            <button className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-md text-sm px-4 py-1 text-center mr-2 ">
              <svg
